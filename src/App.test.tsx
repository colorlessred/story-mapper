...
describe("add next", () => {
  describe("journey", () => {
    ...
    it('board', () => {
      expect(sm.buildBoard().toString())
        .toEqual("[[,journey,,,journey][,step,step,step,step]]");
    })}
  );
  ...
  describe("create next journey", () => {
    ...
    it('board', () => {
      expect(sm.buildBoard().toString())
      // this should not be equal to the previous one since we have added 
      // a new journey
        .toEqual("[[,journey,,,journey][,step,step,step,step]]!wrong");
    });
  });
